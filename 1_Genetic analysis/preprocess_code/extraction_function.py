...
def extract_updrs3(path='../ppmi_data/',version='_05Sep2023'):
    ...
    ## 
    condition = (updrs3_temp['PDSTATE'] == 'OFF') | (updrs3_temp['PDSTATE'].isnull() & updrs3_temp['PAG_NAME'].isin(['NUPDRS3', 'NUPDR3OF', 'NUPDRDOSE3']))
    updrs3_off = updrs3_temp[condition]
    updrs3_off = updrs3_off.reset_index().drop(['PAG_NAME'], axis=1)
