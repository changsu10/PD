...
## train model
formular=paste0(y,' ~ age_onset_norm + pd_duration_norm + as.factor(SEX) + as.factor(is_white) + as.factor(is_family_pd) + ',m,'*time + ledd_norm + ledd_norm*time + (1+time|PATNO)')
